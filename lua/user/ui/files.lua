...
H.buffer_create = function(path, mappings)
    ...
    vim.api.nvim_buf_set_keymap(buf_id, 'n', '<leader>n', ':lua MiniFiles.close()<LF>', { noremap = true, silent = true })
    vim.api.nvim_buf_set_keymap(buf_id, 'n', '<C-n>', ':lua MiniFiles.close()<LF>', { noremap = true, silent = true })
